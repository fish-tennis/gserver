...
const (
	...
	ErrorCode_ErrorCode_NoLoginServer            ErrorCode = 32  // 没有找到可用的登录服
	ErrorCode_ErrorCode_NoGameServer             ErrorCode = 33  // 没有找到可用的游戏服
...
var (
	ErrorCode_name = map[int32]string{
		...
		32:  "ErrorCode_NoLoginServer",
		33:  "ErrorCode_NoGameServer",
	...
	ErrorCode_value = map[string]int32{
		...
		"ErrorCode_NoLoginServer":            32,
		"ErrorCode_NoGameServer":             33,
...
const file_error_code_proto_rawDesc = "" +
	"\n" +
	"\x10error_code.proto\x12\agserver*\xb0\b\n" +
	"\tErrorCode\x12\x10\n" +
	...
	"\x17ErrorCode_NoLoginServer\x10 \x12\x1a\n" +
	"\x16ErrorCode_NoGameServer\x10!\x12\x1b\n" +
