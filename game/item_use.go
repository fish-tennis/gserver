...
// 物品使用接口
type ItemUseFunc func(player *Player, itemCfg *pb.ItemCfg, item any, useArgs *pb.ItemUseArgs) error
...
// 加经验的道具
func UseItem_Exp(player *Player, itemCfg *pb.ItemCfg, item any, useArgs *pb.ItemUseArgs) error {
