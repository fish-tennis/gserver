...
// @Client表示是客户端发的消息,工具也可以考虑为客户端生成相应的辅助代码(c#或lua)
// @Client
   RegisterPlayerProtoCodeGen(packetHandlerRegister, "Quest", PacketCommand(pb.CmdQuest_Cmd_FinishQuestReq), new(pb.FinishQuestReq), func(c Component, m proto.Message) {
